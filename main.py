from train import find_lowest_rmse,read_and_clean_data,make_model,plot_to_compare_models,find_lowest_rmse,run_best_model,plot_actual_vs_pred
import pandas as pd
...
def main():
    with mlflow.start_run(run_name="All_Models_Run", experiment_id=experiment_id):
        X_train,X_test,X_train_scaled,X_test_scaled,y_train,y_test=read_and_clean_data(data_path)
